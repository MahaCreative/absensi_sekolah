        ...
        router.delete(route("admin.delete-siswa", { id: id }), {
            onSuccess: () => {
                showAlert(
                    "success",
                    "Berhasil",
                    "Berhasil menghapus 1 data siswa ke database"
                );
            },
            onError: (err) => {
                showAlert(
                    "error",
                    "Gagal",
                    "Gagal menghapus 1 data siswa ke database"
                );
            },
        });
    };
            ...
            <div className="my-3 py-2 px-4 bg-white rounded-md drop-shadow-md overflow-x-auto w-full">
                <div className="flex justify-between items-center py-3 px-3 w-full">
                    <div className="flex item-center gap-x-3">
                        ...
                        <Link
                            as="button"
                            href={route("admin.report-siswa", { ...params })}
                            className="capitalize flex gap-x-3 py-2 px-4 rounded-md bg-green-500 hover:bg-green-600 text-white"
                        >
                            <Print />
                            <p>Laporan Siswa</p>
                        </Link>
                    ...
                    <div className="flex gap-3 items-center">
                        ...
                        >
                            ...
                            {role == "guru" && (
                                <option value="wali">Wali Kelas Saya</option>
                            )}
                            {kelas.map((item, key) => (
